...
/**
 * Represents a single page in the edu.dalbers.carnowcontrol.wizard.
 */
public abstract class Page implements PageTreeNode {
    ...
    /**
     * Current edu.dalbers.carnowcontrol.wizard values/selections.
     */
    protected Bundle mData = new Bundle();
    protected String mTitle = "page";
    protected boolean mRequired = false;
    protected String mParentKey = "page_key";
