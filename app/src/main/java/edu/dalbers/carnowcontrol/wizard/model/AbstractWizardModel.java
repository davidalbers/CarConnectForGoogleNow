...
/**
 * Represents a edu.dalbers.carnowcontrol.wizard model, including the pages/steps in the edu.dalbers.carnowcontrol.wizard, their dependencies, and their
 * currently populated choices/values/selections.
 *
 * To create an actual edu.dalbers.carnowcontrol.wizard model, extend this class and implement {@link #onNewRootPageList()}.
 */
public abstract class AbstractWizardModel implements ModelCallbacks {
    ...
    /**
     * Override this to define a new edu.dalbers.carnowcontrol.wizard model.
     */
    ...
    /**
     * Gets the current list of edu.dalbers.carnowcontrol.wizard steps, flattening nested (dependent) pages based on the
     * user's choices.
     */
